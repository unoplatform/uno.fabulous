...
module ViewUpdaters =
    ...
    let updateItemsViewItems (prevCollOpt: ViewElement array voption) (collOpt: ViewElement array voption) (target: ItemsControl) = 
        let targetColl = 
    ...
    // UNO TODO
    //let updateItemsViewOfTItems<'T when 'T :> DependencyObject> (prevCollOpt: ViewElement array voption) (collOpt: ViewElement array voption) (target: ItemsControl<'T>) = 
    //    let targetColl = 
    //        match target.ItemsSource with 
    //        | :? ObservableCollection<ViewElementHolder> as oc -> oc
    //        | _ -> 
    ...
    // UNO TODO
    //let updateSelectableItemsViewSelectedItems (prevCollOptOpt: int array option voption) (collOptOpt: int array option voption) (target: ListView) = 
    //    let targetColl = 
    ...
    //let updateTableSectionBaseOfTItems<'T when 'T :> DependencyObject> (prevCollOpt: ViewElement array voption) (collOpt: ViewElement array voption) (target: Xamarin.Forms.TableSectionBase<'T>) _ =
    ...
    //let triggerScrollTo (currValue: (obj * obj * ScrollToPosition * AnimationKind) voption) (target: ItemsControl) =
    //    match currValue with
